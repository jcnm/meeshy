...
class BaseConversation(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Conversation']] = 'Conversation'
...
class BaseConversationMember(_PrismaModel):
    __prisma_model__: ClassVar[Literal['ConversationMember']] = 'ConversationMember'
...
class BaseMessageTranslation(_PrismaModel):
    __prisma_model__: ClassVar[Literal['MessageTranslation']] = 'MessageTranslation'
