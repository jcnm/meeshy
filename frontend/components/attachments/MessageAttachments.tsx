        ...
        <div key={attachment.id} className="relative">
          ...
          {canDelete && (
            <button
              ...
              className="absolute top-2 right-2 w-6 h-6 rounded-full bg-red-500 hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700 text-white flex items-center justify-center transition-all shadow-md z-10 opacity-0 hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-red-500"
