...
function generateCacheKey(messageId, sourceLang, targetLang) {
    ...
    for (const user of users) {
        await prisma.conversationMember.create({
            data: {
                ...
                userId: user.id,
                role: user.role === types_1.UserRoleEnum.ADMIN ? types_1.UserRoleEnum.ADMIN : types_1.UserRoleEnum.MEMBER,
                joinedAt: new Date()
            }
        });
    }
