 ...
 */
export interface GetConversationsResponse extends ApiResponse<any[]> {
}
/**
 * Réponse pour une conversation spécifique
 */
export interface GetConversationResponse extends ApiResponse<any> {
}
/**
 * Réponse pour la création d'une conversation
 */
export interface CreateConversationResponse extends ApiResponse<any> {
}
/**
 ...
 */
export declare function createErrorResponse(error: string, code?: string, meta?: ResponseMeta): ApiResponse<never>;
