...
exports.socketIOUserToUser = socketIOUserToUser;
exports.isValidObjectId = isValidObjectId;
exports.getApiConversationId = getApiConversationId;
exports.getDisplayConversationId = getDisplayConversationId;
exports.createApiSuccessResponse = createApiSuccessResponse;
exports.createApiErrorResponse = createApiErrorResponse;
exports.isAuthenticatedUser = isAuthenticatedUser;
exports.isAnonymousParticipant = isAnonymousParticipant;
 ...
 */
function socketIOUserToUser(socketUser) {
    return {
        id: socketUser.id,
 ...
 */
function getApiConversationId(conversation) {
    if (!conversation) {
 ...
 */
function getDisplayConversationId(conversation) {
    if (!conversation) {
        throw new Error('Conversation object is null or undefined');
    }
 ...
 */
function createApiSuccessResponse(data, meta) {
    return {
        success: true,
        data,
        meta
 ...
 */
function createApiErrorResponse(error, code) {
    return {
        success: false,
        error,
        code
