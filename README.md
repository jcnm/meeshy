...
```bash
# Pull latest images
docker pull isopen/meeshy-translator:0.6.34-alpha
docker pull isopen/meeshy-gateway:0.6.34-alpha
docker pull isopen/meeshy-frontend:0.6.34-alpha
docker pull isopen/meeshy:0.6.34-alpha
```
