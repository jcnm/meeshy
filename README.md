...
```bash
# Pull latest images
docker pull isopen/meeshy-translator:0.5.8-alpha
docker pull isopen/meeshy-gateway:0.5.8-alpha
docker pull isopen/meeshy-frontend:0.5.8-alpha
docker pull isopen/meeshy:0.5.8-alpha
```
